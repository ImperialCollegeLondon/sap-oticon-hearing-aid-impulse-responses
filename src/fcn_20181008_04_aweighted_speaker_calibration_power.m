function[cal_energy] = fcn_20181008_04_aweighted_speaker_calibration_power(db_root,post_toa_hold_off_duration)
...
for isubject = 1:nSubjects
    ...
    if isubject==1 ||  ~isequal(this_omni,prev_omni)
        ...
        toa(cal_count,:) = fcn_20181008_01_est_toa(this_omni,fs);
        for iwin = 1:nWin
            params.post_toa_hold_off_duration = post_toa_hold_off_duration(iwin);
            win_ir = fcn_20181008_02_multichannel_window_wrt_toa(this_omni,fs,toa(cal_count,:),params);
